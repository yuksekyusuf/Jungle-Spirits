...
struct ShareButtonView: View {
    ...
    private func shareApp() {
        ...
        let description = "Check out Jungle Spirits, an exciting puzzle game where you can collect spirits and compete with friends. Download now from the App Store!"

        let activityViewController = UIActivityViewController(activityItems: [description, appStoreURL], applicationActivities: nil)
