...
//            }
    ...
    func animateMove(to targetPosition: CGPoint) {
        ...
        let xOffset = targetPosition.x - CGFloat(cellPosition.col) * cellWidth // assuming cellWidth is the width of your cells
        let yOffset = targetPosition.y - CGFloat(cellPosition.row) * cellWidth // assuming cellHeight is the height of your cells
